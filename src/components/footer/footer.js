...
const Footer = () => {
  return (
    <div className='w-full h-[476px] bg-[#white] border border-primaryColor flex justify-center items-center flex-col pt-[10px] border-[#E6E6E6] '>
      <div className=''>
        <Link to='/Admin-Login'>
          <img src={Logo} alt='kuliner.go-icon' className='w-[230px] h-[52px] relative top-[50px] right-[580px] cursor-pointer'/>
        </Link>
        <div className='relative right-[580px] top-[200px] '>
        ...
        <div className='font-bold text-[24px] relative left-[250px] bottom-[240px] '>
          ...
          Gedung Mewah, Jalan Belak-belok 
          No 12, Bojongsoang, Bandung 12230
          </p>

          <p className='font-extrabold text-[18px] relative top-9 left-[26px] '>
            Phone : <span className='font-light '>0220102038
              </span>
          </p>
          <BsFillTelephoneFill size={20} className='absolute bottom-[-4px] right-[310px]'/> 
          <div className='relative left-[26px]'>
            ...
            <SiGmail size={20} className='absolute bottom-[-60px] right-[333px]'/>
          </div>
        </div>
